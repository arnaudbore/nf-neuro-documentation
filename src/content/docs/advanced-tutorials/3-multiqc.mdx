...
been deeply covered in the [create your own module tutorial](/contribute/create-your-module/2-main/#including-quality-control-qc-steps-within-your-module).
...
the title of our section containing our FA QC image and its description. 
    ...
    repository](https://github.com/modules/blob/main/assets/multiqc_config.yml).
    :::
