...
everything that comes bundled in the `nf-neuro/tutorial` repository. You can call commands to look
...
The simpler way is to **copy your data** in the <span class="dark:text-blue-300 text-blue-500">tutorial</span>
...
available in the <span class="dark:text-blue-300 text-blue-500">editor</span>, to the <span class="dark:text-blue-300 text-blue-500">tutorial</span>
...
1. Mounting paths in the devcontainer
    ...
    Look for the **mounts** entry, near <span class="dark:text-blue-300 text-blue-500">line 15</span>. To define a mount point add the
    ...
    Replace <span class="dark:text-blue-300 text-blue-500">\<source\></span> by the **absolute path** to the data
    on your computer and <span class="dark:text-blue-300 text-blue-500">\<target\></span> with the name of the directory
...
2. Piggyback on Nextflow
    ...
    is that it handles **remote files** quite well. By that, we mean <span class="dark:text-blue-300 text-blue-500">HTTP
    links</span>, <span class="dark:text-blue-300 text-blue-500">amazon s3 buckets</span> and even <span class="dark:text-blue-300 text-blue-500">
