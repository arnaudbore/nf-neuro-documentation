...
in **VSCode**, configured with [nf-neuro](https://github.com/nf-neuro/modules) and
[nf-core](https://nf-co.re) tools suites, ready for quick pipeline development for
**neuroimaging** in [Nextflow](https://nextflow.io).
:::
...
1. In you VSCode window, find <CloneIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden />
   <span class="dark:text-blue-300 text-blue-500">Clone git repository</span> under the **Start** main menu.
...
3. **Search and select** `nf-neuro/tutorial`. Set a download location for the repository
   when asked, anywhere is fine.

   ![vscode find tutorial](../../../assets/images/vscode-clone-selection.png)
...
1. Install the <span class="dark:text-blue-300 text-blue-500">Dev Containers</span> extension. You'll
   find it in the <ExtensionsIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden />
   <span class="dark:text-blue-300 text-blue-500">Extension Marketplace</span>, located in the navigation bar on the left.

   ![dev containers extension](../../../assets/images/devcontainers-extension.png)
   
2. Locate and click on the <span class="dark:text-blue-300 text-blue-500">Remote Window Menu</span> icon
...
3. Find the <span class="dark:text-blue-300 text-blue-500">Reopen in Container</span> option and click it.

   ![reopen in container](../../../assets/images/reopen-in-container.png)

4. Wait a few minutes for the container to build. <span class="hover:text-yellow-700">It's
...
available yet, indicated by a <WaitIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden />
<span class="dark:text-blue-300 text-blue-500">wait icon</span> over the <ExtensionsIcon class="inline-icon" aria-hidden />
...
through the <span class="dark:text-blue-300 text-blue-500">Explorer panel</span> on the left.
</TabItem>
<TabItem label="Editor area">
Clicking on any file in the <span class="dark:text-blue-300 text-blue-500">Explorer panel</span> will open it in the
...
the container**, like <span class="dark:text-blue-300 text-blue-500">nextflow</span>, <span class="dark:text-blue-300 text-blue-500">nf-core</span>, 
<span class="dark:text-blue-300 text-blue-500">nf-test</span> and <span class="dark:text-blue-300 text-blue-500">docker</span>.
</TabItem>
</Tabs>
...
2. **nf-core/tools**
   ...
   ```bash frame="none"      
   INFO    Modules available from https://github.com/nf-neuro/modules.git (main)
   ```
...
4. **nf-test**
   ...
   have to wait around 5 to 20 minutes, for it pull docker containers and run, maybe more depending on your
