...
To include a T1w image in the pipeline, we will follow the same approach from [**Part 2**](/pipeline/3-tutorial_steps_1-2) as we did for the DWI images.
...
#### b. Prepare structure input for the subworkflow
    ...
    As with modules, the API documentation also lists [**subworkflows**](/api), 
