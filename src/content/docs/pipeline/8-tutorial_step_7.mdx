...
But this is just the beginning! 🚀 If you're ready to dive deeper, check out our [advanced tutorials](/guides/advanced-tutorials/1-bidsinput)
for more complex use cases, or explore the [How-To](/guides/how-to/nextflow/1-top-5-operators) section to sharpen
