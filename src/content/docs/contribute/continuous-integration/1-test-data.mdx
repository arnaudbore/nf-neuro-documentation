...
2. A **Nextflow subworkflow**, [LOAD_TEST_DATA](/api/subworkflows/load_test_data), 
...
<span class="dark:text-blue-300 text-blue-500">**[If working in the _devcontainer_, the extension is already installed and setup for you]**</span> Else,
go to the <ExtensionsIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden /><span class="dark:text-blue-300 text-blue-500">Extension Marketplace</span>
...
Once installed, a **new tab section will appear in the <span class="dark:text-blue-300 text-blue-500">Explorer Panel</span>**.
...
- You can <ViewIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden /><span class="dark:text-blue-300 text-blue-500">Display the files content</span>
  in the <span class="dark:text-blue-300 text-blue-500">VSCode Editor Area</span>.
...
- You can <DownloadIcon class="inline-icon dark:text-blue-300 text-blue-500" aria-hidden /><span class="dark:text-blue-300 text-blue-500">Copy the file</span>
...
The [LOAD_TEST_DATA](/api/subworkflows/load_test_data) subworkflow not only downloads and unpacks test data archives, but also
...
names can be derived from the names displayed in the extension, or from the [json file](https://github.com/nf-neuro/modules/tree/main/tests/test_data.json)
