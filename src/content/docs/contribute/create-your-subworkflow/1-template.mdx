...
[denoising](/api/modules/denoising/nlmeans), [brain extraction](/api/modules/betcrop/antsbet),
[intensity normalization](/api/modules/preproc/n4) and [segmentation](/api/subworkflows/anatomical_segmentation).

## First steps

<span class="dark:text-blue-300 text-blue-500">**[Skip if working in the devcontainer]**</span> If not done already, **clone the nf-neuro repository**
locally and navigate to it :

```bash
git clone https://github.com/nf-neuro/modules.git
cd nf-neuro
```
