...
[nf-neuro](https://github.com/nf-neuro/modules) modules and subworkflows
development.
:::
...
3. Search and select **nf-neuro/modules**. Set a download location for the repository
...
The whole content of the **nf-neuro repository** you cloned locally on your computer is accessible
