...
2. **They are _static_**. Their value is bound to the module's name. _Dynamic parameters_ have to be defined using
   [inputs](/create-your-module/2-main#the-input-section).
</Steps>
...
those parameters in the [subworkflow configuration](/create-your-subworkflow/3-configuration) section. For now,
