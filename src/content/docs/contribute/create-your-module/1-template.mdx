...
to [its implementation](https://github.com/nf-neuro/modules/tree/main/modules/nf-neuro/denoising/nlmeans) if needed.
...
<span class="dark:text-blue-300 text-blue-500">**[Skip if working in the devcontainer]**</span> If not done already, **clone the nf-neuro repository** locally and navigate to it :
