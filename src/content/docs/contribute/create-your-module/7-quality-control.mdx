...
if specified in the **_nextflow.config_** file, using the `ext.run_qc` scope.
...
For more complete example, you can refer to the [`preproc/topup`](https://github.com/nf-neuro/modules/blob/main/modules/nf-neuro/preproc/topup/main.nf),
[`preproc/eddy`](https://github.com/nf-neuro/modules/blob/main/modules/nf-neuro/preproc/eddy/main.nf),
or [`registration/anattodwi`](https://github.com/nf-neuro/modules/blob/main/modules/nf-neuro/registration/anattodwi/main.nf) module.